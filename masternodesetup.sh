...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='cryba.conf'
CONFIGFOLDER='/root/.cryba'
COIN_DAEMON='crybad'
COIN_CLI='cryba-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/Cryptoballnet/cryba/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
